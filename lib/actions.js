...
async function fund(transactionBuilder, addAll = false, tipHeader) {
    tipHeader = tipHeader ?? await (0, lumos_utils_1.getRpc)().getTipHeader();
    ...
    const tipEpoch = (0, lumos_utils_1.parseEpoch)(tipHeader.epoch); //Maybe pass as parameter to the fund function///
    ...
    return (0, lumos_utils_1.fund)(transactionBuilder, addAll, tipHeader);
}
exports.fund = fund;
