...
exports.LimitOrderCodec = exports.ArgsLimitOrderCodec = exports.PartialLimitOrderCodec = exports.PositiveUint64LE = exports.BooleanCodec = exports.fulfill = exports.cancel = exports.create = exports.isValid = void 0;
...
const utils_2 = require("@ckb-lumos/base/lib/utils");
...
function isValid(order) {
    ...
    if (type !== undefined && unpacked.sudtHash !== (0, utils_2.computeScriptHash)(type)) {
        return false;
    }
